...
#ifdef USE_MPI
     do i=1,n
        call MPI_BCast(ampt(i,1:12), 12, MPI_DOUBLE_PRECISION, 0, MPI_COMM_FESOM_C, ierror)
        call MPI_BCast(fazt(i,1:12), 12, MPI_DOUBLE_PRECISION, 0, MPI_COMM_FESOM_C, ierror)
     end do
#endif
