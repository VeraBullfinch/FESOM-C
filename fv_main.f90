...
!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 allocate(depth(nod2D))
  ...
  CLOSE(22)
 ! do n=1,nod2D
 !   if(depth(n) < 1.5_WP ) depth(n) = 1.5_WP  ! depth is positive
 !enddo
...
!write(*,*) "time step: ", n_dt
   n_dt2=n_dt2+1
    ...
    if (n_dt <= 180) amA = 0.1_WP
    if (n_dt > 180 .and. n_dt <= 360) amA = 0.2_WP
    if (n_dt > 360 .and. n_dt <= 900) amA = 0.3_WP
    if (n_dt > 900 .and. n_dt <= 1800) amA = 0.4_WP
    if (n_dt > 1800 .and. n_dt <= 3600) amA = 0.5_WP
    if (n_dt > 3600 .and. n_dt <= 5400) amA = 0.6_WP
    if (n_dt > 5400 .and. n_dt <= 7200) amA = 0.7_WP
    if (n_dt > 7200 .and. n_dt <= 9000) amA = 0.8_WP
    if (n_dt > 9000 .and. n_dt <= 10800) amA = 0.9_WP
    if (n_dt > 10800) amA = 1.0_WP
